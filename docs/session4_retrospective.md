# Session 4: Calibration Analysis & Recalibration — Retrospective
...
Session 4's goal: **diagnose** this bias quantitatively with calibration curves, then **correct** it with post-hoc recalibration integrated into the serving pipeline.
...
## 7. Recommendations for Session 5
