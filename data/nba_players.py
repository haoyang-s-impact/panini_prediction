...
# Player Tiers for price modeling (based on card market value tiers)
PLAYER_TIERS = {
    # Superstar tier (12) - MVPs and perennial top-5 players
    ...
    "Kyrie Irving": "superstar",

    # Star tier (~28) - Rising stars + All-Stars
    "Ja Morant": "star",
    "Zion Williamson": "star",
    ...
    "Draymond Green": "star",
    "Rudy Gobert": "star",
    "Khris Middleton": "star",
    "Jrue Holiday": "star",

    # Starter tier (~40) - High-value rookies + solid veterans
    ...
    "Dejounte Murray": "starter",
    "OG Anunoby": "starter",
    "Fred VanVleet": "starter",
    "CJ McCollum": "starter",
    "Anfernee Simons": "starter",
    "Bennedict Mathurin": "starter",
    "Jabari Smith Jr": "starter",
    "Keegan Murray": "starter",

    # Default: any player not in this dict → "rotation"
}
